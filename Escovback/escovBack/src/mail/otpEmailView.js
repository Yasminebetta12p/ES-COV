                        ...
                        <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                ...
                                <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                    ...
                                    <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;color:#0a192f;"><b>Reset Password At ESCOV!</b></p>
                                    <h1 style="color:#0a192f;">OTP is ${otp}</h1>
                                    <p style="font-weight:bold;color:#0a192f;"> Otp will expire after 2 minutes </p>
                                    <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;color:#0a192f;">Thank you for using ESCOV service.</p>
